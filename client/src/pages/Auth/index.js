        ...
        <Grid item xs={0} sm={4} md={6}>
          <Box className="header-text">
            <Typography variant="h2" component="h3">
              campus<span style={{ color: "#df861d" }}>vent</span>
            </Typography>
            <Typography component="h5">
              campusvent brings all your events to you on one social tab
            </Typography>
          </Box>
        </Grid>
          ...
          >
            ...
            >
              ...
              <Box className="actions-box">
                ...
                <Link className="forget-password" href="#" variant="body2">
                  Forgot password?
                </Link>
                <Divider>
                  <Chip
                ...
                <GoogleLogin
                  ...
                  render={(renderProps) => (
                    <Box className="google-auth" onClick={renderProps.onClick}>
                      {" "}
                ...
                />
                <Link className="switch-link" onClick={switchMode}>
                  {isSignup ? "Log In" : "Sign Up for campusvent"}
                </Link>
              </Box>
            </Box>
          </Paper>
