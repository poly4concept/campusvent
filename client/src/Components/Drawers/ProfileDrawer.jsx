    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Link to="/home" className="nav-logo logo home-logo">
              campus<span>vent</span>
            </Link>
            <CloseIcon
              onClick={closeDrawer}
          ...
          <nav className="nav-options">
            <ul class="navbar">
              <li className="nav-item">
                ...
                <Link to="/home" class="item-link">
                  Home
                </Link>
              </li>
              <li className="nav-item">
                <BsFillBookmarkPlusFill className="nav-icon" />
                <Link to="/bookmark" className="item-link">
                  Bookmark
                </Link>
              </li>
              <li className="nav-item">
                <HiOutlineTicket className="nav-icon" />
                <Link to="/notification" className="item-link">
                  Notification
                </Link>
              </li>
              {/* <li className="nav-item">
              ...
              <Link to="/create" className="create-btn">
                <HiPencil className="create-icon" />
                <div className="text">Create Event</div>
              </Link>
            </ul>
          </nav>
          <Box onClick={handleLogOut} className="log-out">
            {" "}
